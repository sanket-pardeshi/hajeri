package com.example.attendancechecker.main.schedule;
...
//    ArrayAdapter<String> adapter;
    ...
    private void loadSchedules() {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(getBaseContext(), android.R.layout.simple_list_item_1, subs);
